...
import Homeusu from "../home/Homeusu";
    ...
    <div className="container  bodyHome">
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="password">
          ...
          />
          <buttom className="toggle" type="button" onClick={()=>{MostrarPassword()}}></buttom>
       
        </div>
        <button className="control" type="submit">Ingresar</button>
      </form>
      </div>
    </div>
  );
